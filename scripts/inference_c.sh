...
OUTPUT_PATH=/media/cormond/hdd/data/pilot_oct10/$TAKE_NAME/smplx_overlay
...
ffmpeg -y -framerate ${FPS} \
    ...
    -q:v 2 \
    -pix_fmt yuv420p \
    /media/cormond/hdd/data/pilot_oct10/$TAKE_NAME/smplx_overlay/smplx_overlay_${TAKE_NAME}_cam${CAM_ID}.mp4
